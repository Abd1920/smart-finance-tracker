import { MdEdit, MdDelete, MdAccountBalance, MdCreditCard, MdSavings, MdAccountBalanceWallet } from 'react-icons/md';
...
const AccountCard = ({ account, onEdit, onDelete, currency = 'LKR' }) => {
  ...
  return (
    <div className="card hover:shadow-md transition-shadow">
      ...
      <div className="border-t border-gray-100 dark:border-gray-700 pt-4">
        ...
        <p className={`text-xl font-bold ${isNegative ? 'text-red-500' : 'text-gray-800 dark:text-gray-100'}`}>
